...
# simple example
# python predict.py flowers/test/21/image_06805.jpg train_checkpoint.pth --gpu
# complete example
# python predict.py flowers/test/21/image_06805.jpg train_checkpoint.pth --top_k 3 --category_names cat_to_name.json --gpu
