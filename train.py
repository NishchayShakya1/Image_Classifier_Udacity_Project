...
def train_model(epochs, optimizer, trainloader, validateloader, device, model,  criterion ):
    steps = 0
    running_loss = 0
    print_every = 5
...
def save_checkpoint(file_path, epochs, model, image_datasets,  optimizer, learning_rate, arch, input_size, output_size, hidden_units):
...
def main():
    ...
    train_model(args.epochs, optimizer, dataloaders[0], dataloaders[1], device, model,  criterion)

    file_path = args.save_dir

    output_size = 102
    save_checkpoint(file_path, args.epochs, model, image_datasets,  optimizer, args.learning_rate,
                    args.arch, num_in_features, output_size,  args.hidden_units)
